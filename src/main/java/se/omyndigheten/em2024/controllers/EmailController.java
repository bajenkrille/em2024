...
public class EmailController {
    ...
    @Value("${pathtotips}")
    private String path;
    private static final String HTML_MAIL = "<h2>Välkommen till The one and only EM-tips 2024</h2>"
    ...
    public String matchTipsSubmit(@ModelAttribute TipsController.MatchTipsListWrapper matchTipsWrapper, @RequestParam("deltagareEpost") String deltagareEpost,
        ...
        try {
            emailService.sendMessageWithAttachment(deltagareEpost, "Ämne", HTML_MAIL, filePath);
